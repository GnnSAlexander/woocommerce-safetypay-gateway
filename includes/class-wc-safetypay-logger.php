 ...
 * Log all things!
 */
class WC_Safetypay_Logger {

    /**
     * Vars
     */
    public static $logger;
	const WC_LOG_FILENAME = 'woocommerce-gateway-safetypay';
	...
	public static function log( $message, $single = true, $start_time = null, $end_time = null ) {
		...
		if ( apply_filters( 'wc_safetypay_logging', true, $message ) ) {
			...
			$settings = WC_Safetypay::$settings;
